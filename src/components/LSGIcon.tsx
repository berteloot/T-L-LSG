...
// LSG Custom Icon System - 32x32 grid, 2-unit stroke weight
const LSGIcon: React.FC<LSGIconProps> = ({ 
  name, 
  size = 'md', 
  className = '', 
  strokeWidth = 2 
  ...
  const iconPaths: Record<string, string> = {
    // Core LSG Icons - following 32x32 grid system
    'check': 'M8 16l4 4 8-8',
    'arrow-right': 'M4 16h16M12 4l8 8-8 8',
    'arrow-left': 'M20 16H4M12 4l-8 8 8 8',
    'arrow-up': 'M16 8l-8 8-8-8',
    'arrow-down': 'M8 16l8-8 8 8',
    ...
    'warehouse': 'M3 21h18M5 21V7l8-4 8 4v14M9 9v12M15 9v12',
    ...
    'shield': 'M12 22s8-9 8-13a8 8 0 00-16 0c0 4 8 13 8 13z',
    'lock': 'M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z',
    'unlock': 'M8 11V7a4 4 0 118 0m-4 8v2m-6-4h12a2 2 0 012 2v6a2 2 0 01-2 2H6a2 2 0 01-2-2v-6a2 2 0 012-2z',
  ...
  if (!path) {
    console.warn(`LSGIcon: Icon "${name}" not found`);
    return null;
  }
